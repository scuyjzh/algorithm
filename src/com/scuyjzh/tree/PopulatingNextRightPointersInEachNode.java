    ...
    public Node connect2(Node root) {
        ...
        while (leftmost.left != null) {
            ...
            while (head != null) {
                ...
                // CONNECTION 2：
                // 连接不同父节点之间的子节点。更具体地说，连接的是第一个父节点的右孩子和第二父节点的左孩子
                // 由于已经在父节点这一层建立了 next 指针，因此可以直接通过第一个父节点的 next 指针找到第二个父节点，然后在它们的孩子之间建立连接
                if (head.next != null) {
            ...
            // 完成当前层的连接后，进入下一层重复操作，直到所有的节点全部连接
            // 进入下一层后需要更新最左节点，然后从新的最左节点开始遍历该层所有节点
            // 因为是完美二叉树，因此最左节点一定是当前层最左节点的左孩子
